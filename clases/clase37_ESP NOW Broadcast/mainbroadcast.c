...
static uint8_t peer_mac[ESP_NOW_ETH_ALEN]={0x58,0xcf,0x79,0x04,0x45,0x98};//no se utiliza
static uint8_t bc_mac[ESP_NOW_ETH_ALEN]={0xff,0xff,0xff,0xff,0xff,0xff};//no se utiliza
